...
class ContactMessagesControllerTest < ActionController::TestCase
  ...
  test "should create contact_message" do
    assert_difference('ContactMessage.count') do
      post :create, contact_message: { contact_request_id: @contact_message.contact_request_id, content: @contact_message.content, user_id: @contact_message.user_id }
    end
  ...
  test "should update contact_message" do
    patch :update, id: @contact_message, contact_message: { contact_request_id: @contact_message.contact_request_id, content: @contact_message.content, user_id: @contact_message.user_id }
    assert_redirected_to contact_message_path(assigns(:contact_message))
  end
